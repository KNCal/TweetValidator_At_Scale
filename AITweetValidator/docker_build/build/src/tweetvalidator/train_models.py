...
def train_models(model, data_column,
    ...
    for user in users:
        ...
        with open(model_path, 'wb') as f:
            pk.dump(model, f)
        upload_file(model_path, "twitterdataprojectfraud", "output/"+  user + "_model.pkl")     
        ...
        upload_file(conf_matrix_path, "twitterdataprojectfraud", "output/"+  user + "_conf_mat.txt")    
        ...
        upload_file(details_path, "twitterdataprojectfraud", "output/"+  user + "_details.txt")
